...
const FeaturedMedi: React.FC = () => {
    ...
    // ✅ যদি লোডিং চলে তাহলে স্লিকটন দেখাবে
    if (loading) {
        return (
    ...
    // ✅ যদি কোনো মেডিসিন না থাকে তাহলে মেসেজ দেখাবে
    ...
    const featuredMedi = medicines.slice(0, 6);
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                {featuredMedi.map((data) => (
                    <div key={data.id} className="bg-white p-5 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                        ...
                        <Link href={`/medicine/${data.id}`} className="block mt-4">
