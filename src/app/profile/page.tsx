...
console.log(userInfo)
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`https://medibazser.vercel.app/api/users/${userInfo._id}`, {
                method: 'PATCH',
                headers: {
    ...
    const handlePasswordSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`https://medibazser.vercel.app/users/${userInfo._id}`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                },
